...
function buddymeet_default_settings(){
    return array(
        ...
        'settings' => 'devices,language,moderator,profile',
        'disable_video_quality_label' => true,
        'toolbar' => 'microphone,camera,hangup,desktop,fullscreen,profile,chat,recording,settings,raisehand,videoquality,tileview,closedcaptions,fodeviceselection,info,mute-everyone,etherpad'
    );
}
