...
if (is_array($pack)): ?>
    <div class="stm_lms_downloadable_content__files">
        <?php foreach ($pack as $file):
            ...
            $course_files_label = $file[$file_in_pack_name];
            if (empty($course_files_label)) $course_files_label = esc_html__('Attached file', 'masterstudy-lms-learning-management-system');
